...
class KairouanTarsimCertificateGenerator:
    ...
    def generate_certificate(self, output_path, alanguage='ar', **params):
        ...
        print(f"  Type: {t['main_title']} ({'Registration Certificate' if alanguage=='fr' else 'شهادة ترسيم'})")
...
if __name__ == "__main__":
    ...
    # Certificate data (already present)
    certificate_data = {
        'name': 'أحمد خليل',  # BOLD
        'surname': 'ورشي',  # BOLD
        ...
        'signature_name': 'عثمان عثمان'  # Optional
    }
    # Generate Arabic (default)
    generator.generate_certificate('certificate_tarsim_ar.pdf', alanguage='ar', **certificate_data)
    # Generate French
    ...
    generator.generate_certificate('certificate_tarsim_fr.pdf', alanguage='fr', **certificate_data_fr)