...
from .views import DocumentRequestListCreateView, DocumentRequestDetailView, TerminateDocumentRequestView, RejectDocumentRequestView, ProcessDocumentRequestView, DocumentRequestFileView
...
urlpatterns = [
    ...
    path('demandes/<uuid:public_id>/file', DocumentRequestFileView.as_view(), name='document-request-file'),
]
